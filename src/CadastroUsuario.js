...
function CadastroUsuario() {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log("Dados enviados para o backend:", JSON.stringify(dadosCadastro, null, 2)); 

    try {
      const response = await fetch('http://207.211.191.34:8080/gerenciamento-usuarios/api/cadastro/cliente', { 
        method: 'POST',
        headers: {
